...
The repository supports the paper's central prototype thesis and now includes a post-paper encrypted LSP v3 topology plus replicated inference, artifacts, gradient quorum/median, dual-signed useful-work credits, diversity, and local-ban controls. It does **not** yet satisfy the paper's target Internet-scale compute ecosystem because pseudonymous identities and unweighted issuers undermine quorum independence, work lacks process isolation/attestation, and governance, key rotation/review, and public seed operations remain. The correct current stage remains **Infant / research prototype**.
