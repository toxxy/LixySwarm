...
- Scheduling capacity declarations are self-reported. Verified useful-work evidence affects ordering, but there is no Sybil-independent issuer reputation/aging, fairness queue, hardware attestation, general redundant execution beyond verified inference, or failure rescheduling.
