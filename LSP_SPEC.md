...
- Official threshold trust roots/genesis artifacts, multi-provider content lookup beyond the announcing peer, cross-hardware validation of replicated inference, durable fair-share queues, quorum-member replacement, forced termination/process isolation, and crash-persistent job recovery.
